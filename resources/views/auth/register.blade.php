            ...
            <div class="auth-card">
                ...
                <form method="POST" action="{{ route('register') }}" data-auth-form data-toast="Akun berhasil dibuat. Mengarahkan ke dashboard...">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="password" name="password" placeholder="Masukkan password minimal 8 karakter" required minlength="8" maxlength="16" autocomplete="new-password">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" id="password_confirmation" name="password_confirmation" placeholder="Masukkan ulang password" required minlength="8" maxlength="16" autocomplete="new-password">
