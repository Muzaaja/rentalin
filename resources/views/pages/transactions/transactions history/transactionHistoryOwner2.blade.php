...
<head>
    ...
    <title>Riwayat Transaksi (Pemilik - Halaman 2) - Rental.in</title>
    ...
    <main class="container">
        ...
        <div class="transaction-list">
            <div class="card">
                ...
                <div class="card-body">
                    <img src="{{ asset('assets/img/produk/Rectangle-212@2x.png') }}" alt="Raket Tenis" class="product-img">
                    <div class="product-details">
                        <h3 class="product-name">Raket Tenis</h3>
                ...
                <div class="card-footer">
                    <div class="total-section"><span class="total-label">Total Pesanan</span><span class="total-price">20.000</span></div>
                </div>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <img src="{{ asset('assets/img/produk/Rectangle-217@2x.png') }}" alt="Iphone 16 Pro Max" class="product-img">
                    <div class="product-details">
                        <h3 class="product-name">Iphone 16 Pro Max</h3>
                        <p class="product-variant">1000TB</p>
                        <p class="product-qty">1 Buah</p>
                    </div>
                    <div class="product-price">115.000</div>
                </div>
                <div class="card-footer">
                    <div class="total-section"><span class="total-label">Total Pesanan</span><span class="total-price">115.000</span></div>
                </div>
                <div class="card-actions">
        ...
        <div class="pagination">
            <a href="riwayat_transaksi_pemilik.html" class="page-link"><i class="fa-solid fa-chevron-left"></i></a>
            <a href="riwayat_transaksi_pemilik.html" class="page-link">1</a>
            <a href="riwayat_transaksi_pemilik2.html" class="page-link active">2</a>
        </div>
    </main>
