...
<main class="w-full max-w-[435px] sm:max-w-[940px] lg:max-w-[1220px] mx-auto px-[20px] sm:px-[44px] lg:px-[66px] pt-[22px] sm:pt-[38px] pb-[48px] lg:pb-[70px]">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-[410px_1fr] gap-[28px] items-start">
        ...
        <form action="{{ route('transaksi.simpanKonfirmasiPenerimaan', $rental->id) }}"
              method="POST"
            ...
            <p class="text-[13px] text-[#696969] leading-[22px] mb-[22px]">
                Unggah foto barang saat diterima dan pilih apakah kelengkapan barang sudah sesuai.
                Jika barang tidak lengkap, transaksi langsung dialihkan ke proses pengembalian.
            </p>
            ...
            <div class="mb-[22px]">
                <label class="block text-[14px] font-bold mb-[10px]">
                    Checklist Kelengkapan Barang Diterima
                </label>

                <p class="text-[12px] text-[#696969] leading-[20px] mb-[12px]">
                    Centang kelengkapan barang yang benar-benar diterima.
                    Jika ada yang tidak diterima, pilih kondisi “Tidak Lengkap”.
                </p>
            ...
            <div class="mb-[22px]">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-[12px]">
                    <label class="border border-[#BFD7FF] rounded-[8px] px-[14px] py-[14px] cursor-pointer hover:bg-[#F8FBFF]">
                        <input type="radio" name="acceptance_complete" value="ya" class="mr-[8px]" required>

                        <span class="text-[14px] font-bold text-[#348B55]">
                            Barang Lengkap
                        </span>

                        <p class="text-[12px] text-[#696969] mt-[6px] leading-[18px]">
                            Status transaksi berubah menjadi disewa.
                        </p>
                    </label>

                    <label class="border border-[#F4B8C2] rounded-[8px] px-[14px] py-[14px] cursor-pointer hover:bg-[#FFF8FA]">
                        <input type="radio" name="acceptance_complete" value="tidak" class="mr-[8px]" required>
                        ...
                        <p class="text-[12px] text-[#696969] mt-[6px] leading-[18px]">
                            Status transaksi masuk ke pengembalian.
                        </p>
                    </label>
                </div>
            </div>
