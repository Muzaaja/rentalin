...
<head>
    ...
    <title>Konfirmasi Penerimaan - P2P Rental</title>
        ...
        <div class="rtn-card">
            ...
            <div class="rtn-product-row">
                <div class="rtn-product-info">
                    <img src="https://via.placeholder.com/80" alt="Kompor Listrik Portable" class="rtn-product-img">
                    <div class="rtn-product-details">
                        <h4>Kompor Listrik Portable</h4>
                        <p>-</p>
                        <p>1 Buah</p>
                    </div>
                </div>
            ...
            <div class="rtn-total-row">
                ...
                <span class="rtn-total-value">65.000</span>
            </div>
        </div>

        <div class="rtn-card">
            <h3 class="rtn-card-title">Bukti Penerimaan</h3>
            <p class="rtn-subtitle">Upload foto saat unboxing sebagai bukti penerimaan barang</p>
            
            <div class="rtn-upload-box">
                <input type="file" id="uploadBuktiPenerimaan" class="rtn-file-input" accept="image/jpeg, image/png, application/pdf">
